import{F as e,I as t,M as n,Q as r,b as i,i as a,n as o,ot as s,r as c}from"./doc-page-DrpX4VML.js";import{t as l}from"./alert-Co9TegTE.js";var u=s();function d(){return(0,u.jsxs)(o,{title:`App Shell`,description:`The big boss layout component - header, collapsible sidebar, and main content area, all wired up and ready to go. It's basically an entire app skeleton in one component.`,children:[(0,u.jsxs)(l,{title:`This component is opinionated`,icon:(0,u.jsx)(t,{path:r}),variant:`warn`,children:[`The sidebar navigation is hardcoded to use`,` `,(0,u.jsx)(i,{href:`https://github.com/molefrog/wouter`,rel:`noopener noreferrer`,target:`_blank`,children:`wouter`}),` `,`for routing (specifically `,(0,u.jsx)(e,{code:`Link`,inline:!0}),` and `,(0,u.jsx)(e,{code:`useLocation`,inline:!0}),`). If your project uses a different router (React Router, TanStack Router, Next.js, etc.), the nav links won't work out of the box. The recommended approach: treat this component as a reference implementation and build your own app shell around it. Or, since you have access to the source in`,` `,(0,u.jsx)(e,{code:`@/component/appShell/appShell.tsx`,inline:!0}),`, just swap out the wouter-specific bits for your router of choice - it's pretty self-contained.`]}),(0,u.jsx)(c,{title:`Installation`,children:(0,u.jsx)(e,{code:`npx shadcn@latest add @cartuni/appShell`})}),(0,u.jsxs)(c,{title:`Usage`,children:[(0,u.jsxs)(n,{children:[`The `,(0,u.jsx)(e,{code:`AppShell`,inline:!0}),` gives you a full-page layout with a sticky header, a toggleable sidebar with navigation, and a scrollable main content area. You're literally looking at it right now - this entire docs site is built with it! Meta, right?`]}),(0,u.jsx)(e,{code:`import { AppShell } from '@/component/appShell/appShell';
